    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-6 items-start md:items-center">
        <div className="relative group">
          <div className="absolute inset-0 rounded-full bg-teal-600/20 blur-xl group-hover:bg-teal-600/30 transition-colors" />
          <img 
            src="/profile.jpg" 
            alt="Dexter Balbuena" 
            className="w-32 h-32 rounded-full object-cover border-4 border-white dark:border-slate-800 shadow-md relative z-10 ring-2 ring-teal-600/50"
            onError={(e) => {
        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-3 pt-2">
            <a 
              ...
              className="p-2.5 rounded-full bg-slate-50 hover:bg-teal-50 dark:bg-slate-800 dark:hover:bg-teal-900/30 text-slate-600 hover:text-teal-600 dark:text-slate-400 dark:hover:text-teal-400 transition-colors"
              aria-label="GitHub"
            >
